      ...
      <div className="flex h-full w-full flex-col bg-background">
        <ScrollArea>
          <div className="min-h-[calc(100vh-2rem)]">
            <div className="mb-4 flex items-center justify-between border-b bg-muted/40 px-8 py-2 lg:m-4 lg:mb-0 lg:rounded-lg lg:border lg:px-6">
            ...
            <div className="mx-6 flex justify-center py-6 lg:px-4">
              {children}
            </div>
          </div>
        </ScrollArea>
